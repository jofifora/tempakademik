...
class T_absensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_absensi/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_absensi/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_absensi/index.html';
            $config['first_url'] = base_url() . 'admin/t_absensi/index.html';
        }
        ...
        $this->load->view('admin/t_absensi/t_absensi_list', $data);
    ...
    public function read($id) 
    {
		...
		'alpa' => $row->alpa,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_absensi/t_absensi_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_absensi'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_absensi/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/t_absensi/t_absensi_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_absensi/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_absensi/t_absensi_doc',$data);
    }
