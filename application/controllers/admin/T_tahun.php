...
class T_tahun extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_tahun/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_tahun/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_tahun/index.html';
            $config['first_url'] = base_url() . 'admin/t_tahun/index.html';
        }
        ...
        $this->load->view('admin/t_tahun/t_tahun_list', $data);
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_tahun/t_tahun_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_tahun'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_tahun/create_action'),
	    'id_tahun' => set_value('id_tahun'),
	    'tahun' => set_value('tahun'),
	);
        $this->load->view('admin/header');
        $this->load->view('admin/t_tahun/t_tahun_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_tahun/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_tahun/t_tahun_doc',$data);
    }
