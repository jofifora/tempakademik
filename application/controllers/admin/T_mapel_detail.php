...
class T_mapel_detail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_mapel_detail/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_mapel_detail/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_mapel_detail/index.html';
            $config['first_url'] = base_url() . 'admin/t_mapel_detail/index.html';
        }
        ...
        $this->load->view('admin/t_mapel_detail/t_mapel_detail_list', $data);
    ...
    public function read($id) 
    {
		...
		'id_tahun' => $row->id_tahun,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_mapel_detail/t_mapel_detail_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_mapel_detail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_mapel_detail/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/t_mapel_detail/t_mapel_detail_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_mapel_detail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_mapel_detail/t_mapel_detail_doc',$data);
    }
