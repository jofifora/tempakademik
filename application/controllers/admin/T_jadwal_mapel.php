...
class T_jadwal_mapel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_jadwal_mapel/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_jadwal_mapel/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_jadwal_mapel/index.html';
            $config['first_url'] = base_url() . 'admin/t_jadwal_mapel/index.html';
        }
        ...
        $this->load->view('admin/t_jadwal_mapel/t_jadwal_mapel_list', $data);
    ...
    public function read($id) 
    {
		...
		'jam_selesai' => $row->jam_selesai,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_jadwal_mapel/t_jadwal_mapel_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_jadwal_mapel'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_jadwal_mapel/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/t_jadwal_mapel/t_jadwal_mapel_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_jadwal_mapel/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_jadwal_mapel/t_jadwal_mapel_doc',$data);
    }
