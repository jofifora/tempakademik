...
class T_guru extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_guru/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_guru/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_guru/index.html';
            $config['first_url'] = base_url() . 'admin/t_guru/index.html';
        }
        ...
        $this->load->view('admin/t_guru/t_guru_list', $data);
    ...
    public function read($id) 
    {
		...
		'jenis_kepegawaian' => $row->jenis_kepegawaian,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_guru/t_guru_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_guru'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_guru/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/t_guru/t_guru_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_guru/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_guru/t_guru_doc',$data);
    }
