...
class T_kelas_tahun_ajaran extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_kelas_tahun_ajaran/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_kelas_tahun_ajaran/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_kelas_tahun_ajaran/index.html';
            $config['first_url'] = base_url() . 'admin/t_kelas_tahun_ajaran/index.html';
        }
        ...
        $this->load->view('admin/t_kelas_tahun_ajaran/t_kelas_tahun_ajaran_list', $data);
    ...
    public function read($id) 
    {
		...
		'token' => $row->token,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_kelas_tahun_ajaran/t_kelas_tahun_ajaran_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_kelas_tahun_ajaran'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/t_kelas_tahun_ajaran/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/t_kelas_tahun_ajaran/t_kelas_tahun_ajaran_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_kelas_tahun_ajaran/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_kelas_tahun_ajaran/t_kelas_tahun_ajaran_doc',$data);
    }
