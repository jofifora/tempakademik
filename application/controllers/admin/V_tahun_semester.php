...
class V_tahun_semester extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/v_tahun_semester/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/v_tahun_semester/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/v_tahun_semester/index.html';
            $config['first_url'] = base_url() . 'admin/v_tahun_semester/index.html';
        }
        ...
        $this->load->view('admin/v_tahun_semester/v_tahun_semester_list', $data);
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/v_tahun_semester/v_tahun_semester_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/v_tahun_semester'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('admin/v_tahun_semester/create_action'),
        ...
        $this->load->view('admin/header');
        $this->load->view('admin/v_tahun_semester/v_tahun_semester_form', $data);
        $this->load->view('admin/footer');
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/v_tahun_semester/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/v_tahun_semester/v_tahun_semester_doc',$data);
    }
