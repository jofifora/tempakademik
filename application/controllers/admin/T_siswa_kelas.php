...
class T_siswa_kelas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'admin/t_siswa_kelas/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'admin/t_siswa_kelas/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'admin/t_siswa_kelas/index.html';
            $config['first_url'] = base_url() . 'admin/t_siswa_kelas/index.html';
        }
        ...
        $this->load->view('admin/t_siswa_kelas/t_siswa_kelas_list', $data);
    ...
    public function read($id) 
    {
		...
		'id_kelas_tahun_ajaran' => $row->id_kelas_tahun_ajaran,
            ...
            $this->load->view('admin/header');
            $this->load->view('admin/t_siswa_kelas/t_siswa_kelas_read', $data);
            $this->load->view('admin/footer');
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('admin/t_siswa_kelas'));
        }
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('admin/t_siswa_kelas/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('admin/t_siswa_kelas/t_siswa_kelas_doc',$data);
    }
