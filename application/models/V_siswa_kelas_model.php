...
class V_siswa_kelas_model extends CI_Model
{

    public $table = 'v_siswa_kelas';
...
/* End of file V_siswa_kelas_model.php */
/* Location: ./application/models/V_siswa_kelas_model.php */
