...
class V_jadwal_mapel_model extends CI_Model
{

    public $table = 'v_jadwal_mapel';
...
/* End of file V_jadwal_mapel_model.php */
/* Location: ./application/models/V_jadwal_mapel_model.php */
