        ...
        <div class="row">
            <div class="col-lg-12">
                <h3 class="page-header">
                    <?php echo $button ?> Data Jadwal Mapel
                </h3>
            </div>
        </div>
        <!-- /.row -->
	    ...
	    <input type="hidden" name="" value="<?php echo $id_jadwal_mapel; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('admin/v_jadwal_mapel') ?>" class="btn btn-default">Cancel</a>
	</form>