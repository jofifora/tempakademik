        <h2 style="margin-top:0px">V_nilai Read</h2>
        <table class="table">
	    ...
	    <tr><td>Jenis Kelamin Guru</td><td><?php echo $jenis_kelamin_guru; ?></td></tr>
	    <tr><td>Tempat Lahir Guru</td><td><?php echo $tempat_lahir_guru; ?></td></tr>
	    <tr><td>Tanggal Lahir Guru</td><td><?php echo $tanggal_lahir_guru; ?></td></tr>
	    <tr><td>Alamat Guru</td><td><?php echo $alamat_guru; ?></td></tr>
	    <tr><td>Agama Guru</td><td><?php echo $agama_guru; ?></td></tr>
	    ...
	    <tr><td>Telp Wali</td><td><?php echo $telp_wali; ?></td></tr>
	    ...
	    <tr><td></td><td><a href="<?php echo site_url('admin/v_nilai') ?>" class="btn btn-default">Cancel</a></td></tr>
	</table>