	    ...
	    <div class="form-group">
            <label for="bigint">Id Absensi <?php echo form_error('id_absensi') ?></label>
	    ...
	    <input type="hidden" name="" value="<?php echo $id_absensi; ?>" /> 
	    <button type="submit" class="btn btn-primary"><?php echo $button ?></button> 
	    <a href="<?php echo site_url('admin/v_absensi') ?>" class="btn btn-default">Cancel</a>