...
class T_tahun_semester extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't_tahun_semester/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't_tahun_semester/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't_tahun_semester/index.html';
            $config['first_url'] = base_url() . 't_tahun_semester/index.html';
        }
        ...
        $this->load->view('t_tahun_semester/t_tahun_semester_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'semester' => $row->semester,
            ...
            $this->load->view('t_tahun_semester/t_tahun_semester_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('t_tahun_semester'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('t_tahun_semester/create_action'),
	    'id_tahun_semester' => set_value('id_tahun_semester'),
	    'id_tahun' => set_value('id_tahun'),
	    'semester' => set_value('semester'),
	);
        $this->load->view('t_tahun_semester/t_tahun_semester_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('t_tahun_semester/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('t_tahun_semester/t_tahun_semester_doc',$data);
    }
