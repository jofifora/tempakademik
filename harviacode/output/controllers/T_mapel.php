...
class T_mapel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't_mapel/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't_mapel/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't_mapel/index.html';
            $config['first_url'] = base_url() . 't_mapel/index.html';
        }
        ...
        $this->load->view('t_mapel/t_mapel_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_mapel' => $row->nama_mapel,
            ...
            $this->load->view('t_mapel/t_mapel_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('t_mapel'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('t_mapel/create_action'),
	    'id_mapel' => set_value('id_mapel'),
	    'nama_mapel' => set_value('nama_mapel'),
	);
        $this->load->view('t_mapel/t_mapel_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('t_mapel/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('t_mapel/t_mapel_doc',$data);
    }
