...
class V_absensi extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'v_absensi/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'v_absensi/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'v_absensi/index.html';
            $config['first_url'] = base_url() . 'v_absensi/index.html';
        }
        ...
        $this->load->view('v_absensi/v_absensi_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('v_absensi/v_absensi_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('v_absensi'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('v_absensi/create_action'),
        ...
        $this->load->view('v_absensi/v_absensi_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('v_absensi/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('v_absensi/v_absensi_doc',$data);
    }
