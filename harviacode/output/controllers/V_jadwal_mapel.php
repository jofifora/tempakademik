...
class V_jadwal_mapel extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'v_jadwal_mapel/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'v_jadwal_mapel/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'v_jadwal_mapel/index.html';
            $config['first_url'] = base_url() . 'v_jadwal_mapel/index.html';
        }
        ...
        $this->load->view('v_jadwal_mapel/v_jadwal_mapel_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_kelas' => $row->nama_kelas,
            ...
            $this->load->view('v_jadwal_mapel/v_jadwal_mapel_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('v_jadwal_mapel'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('v_jadwal_mapel/create_action'),
        ...
        $this->load->view('v_jadwal_mapel/v_jadwal_mapel_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('v_jadwal_mapel/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('v_jadwal_mapel/v_jadwal_mapel_doc',$data);
    }
