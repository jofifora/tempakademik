...
class T_kelas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't_kelas/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't_kelas/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't_kelas/index.html';
            $config['first_url'] = base_url() . 't_kelas/index.html';
        }
        ...
        $this->load->view('t_kelas/t_kelas_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'nama_kelas' => $row->nama_kelas,
            ...
            $this->load->view('t_kelas/t_kelas_read', $data);
        } else {
    ...
    public function word()
    {
        ...
        $this->load->view('t_kelas/t_kelas_doc',$data);
    }
