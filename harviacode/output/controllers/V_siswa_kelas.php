...
class V_siswa_kelas extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'v_siswa_kelas/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'v_siswa_kelas/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'v_siswa_kelas/index.html';
            $config['first_url'] = base_url() . 'v_siswa_kelas/index.html';
        }
        ...
        $this->load->view('v_siswa_kelas/v_siswa_kelas_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('v_siswa_kelas/v_siswa_kelas_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('v_siswa_kelas'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('v_siswa_kelas/create_action'),
        ...
        $this->load->view('v_siswa_kelas/v_siswa_kelas_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('v_siswa_kelas/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('v_siswa_kelas/v_siswa_kelas_doc',$data);
    }
