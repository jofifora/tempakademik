...
class V_nilai extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'v_nilai/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'v_nilai/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'v_nilai/index.html';
            $config['first_url'] = base_url() . 'v_nilai/index.html';
        }
        ...
        $this->load->view('v_nilai/v_nilai_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('v_nilai/v_nilai_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('v_nilai'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('v_nilai/create_action'),
        ...
        $this->load->view('v_nilai/v_nilai_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('v_nilai/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('v_nilai/v_nilai_doc',$data);
    }
