...
class V_mapel_detail extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 'v_mapel_detail/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 'v_mapel_detail/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 'v_mapel_detail/index.html';
            $config['first_url'] = base_url() . 'v_mapel_detail/index.html';
        }
        ...
        $this->load->view('v_mapel_detail/v_mapel_detail_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'tahun' => $row->tahun,
            ...
            $this->load->view('v_mapel_detail/v_mapel_detail_read', $data);
        } else {
            $this->session->set_flashdata('message', 'Record Not Found');
            redirect(site_url('v_mapel_detail'));
        }
    }
    ...
    public function create() 
    {
        $data = array(
            'button' => 'Create',
            'action' => site_url('v_mapel_detail/create_action'),
        ...
        $this->load->view('v_mapel_detail/v_mapel_detail_form', $data);
    }
    ...
    public function update($id) 
    {
        ...
        if ($row) {
            $data = array(
                'button' => 'Update',
                'action' => site_url('v_mapel_detail/update_action'),
    ...
    public function word()
    {
        ...
        $this->load->view('v_mapel_detail/v_mapel_detail_doc',$data);
    }
