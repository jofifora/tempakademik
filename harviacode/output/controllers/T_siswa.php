...
class T_siswa extends CI_Controller
{
    ...
    public function index()
    {
        ...
        if ($q <> '') {
            $config['base_url'] = base_url() . 't_siswa/index.html?q=' . urlencode($q);
            $config['first_url'] = base_url() . 't_siswa/index.html?q=' . urlencode($q);
        } else {
            $config['base_url'] = base_url() . 't_siswa/index.html';
            $config['first_url'] = base_url() . 't_siswa/index.html';
        }
        ...
        $this->load->view('t_siswa/t_siswa_list', $data);
    }
    ...
    public function read($id) 
    {
		...
		'pekerjaan_wali' => $row->pekerjaan_wali,
            ...
            $this->load->view('t_siswa/t_siswa_read', $data);
        } else {
    ...
    public function create() 
    {
        ...
        $this->load->view('t_siswa/t_siswa_form', $data);
    }
    ...
    public function word()
    {
        ...
        $this->load->view('t_siswa/t_siswa_doc',$data);
    }
